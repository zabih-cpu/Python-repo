...
# while loop
#  pratice question Q1(print nuber frome 1 t0 100 using while loop)
# i = 1
# while i <= 100:
#     print(i)
#     i += 1

# practice question Q2( print number from 1 to 100 using while loop )
# i = 100
# while i >= 1:
#     print(i)
#     i -= 1 

# # pratice question Q3( print the multiplication table of a number n using while loop  )
# i = 1
# while i <= 10 :
#     print(4*i)
#     i += 
...
tuple  = ('zabih','superman','batman','khan','ironman ')
